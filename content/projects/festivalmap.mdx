...
![Commonalities](/images/festivalmap_commonalities.jpg)
...
- **Preference**:  
  - All participants preferred **integrated prototypes** over the separate festival map and schedule (PDF + map).

- **Main Advantages of Integrated Prototypes**:
  - Faster and easier decision-making with **all info in one place**.
  - Clear **spatial overview** of performances and distances.
  - **Visual display of remaining time** was well-received.
  - Reduced need to memorize or switch between tools.

- **Additional Notes**:
  - Users appreciated the ability to quickly **explore performances live** without needing prior planning.
